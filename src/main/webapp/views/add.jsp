            ...
            <div class="card-body p-5">
              ...
              <form action="insert-product" method="post">
                ...
                <label class="form-label" for="form3Example1cg">Product Price</label>
                  <input type="number" name="price" id="form3Example1cg" class="form-control form-control-lg" />
                  
                </div>
                 <div data-mdb-input-init class="form-outline mb-4">
                   <label class="form-label" for="form3Example1cg">Product Quantity</label>
                  <input type="number" name="quantity"   id="form3Example1cg" class="form-control form-control-lg" />
                
                </div>
                 <div data-mdb-input-init class="form-outline mb-4">
                 <label class="form-label" for="form3Example1cg">Product Category</label>
                  <input type="text" name="category" id="form3Example1cg" class="form-control form-control-lg" />
